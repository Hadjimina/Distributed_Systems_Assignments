 ...
 * @see SensorListener
 */
public abstract class AbstractSensor implements a4.vs.inf.ethz.ch.vs_davidn_phoneserver.task1and2.Sensor {
    protected List<a4.vs.inf.ethz.ch.vs_davidn_phoneserver.task1and2.SensorListener> listeners = new ArrayList<a4.vs.inf.ethz.ch.vs_davidn_phoneserver.task1and2.SensorListener>();
    ...
    protected void sendMessage(String message) {
        for (a4.vs.inf.ethz.ch.vs_davidn_phoneserver.task1and2.SensorListener listener : listeners) {
     ...
     * The response is parsed by {@link a4.vs.inf.ethz.ch.vs_davidn_phoneserver.task1and2.Sensor#parseResponse(String)}
